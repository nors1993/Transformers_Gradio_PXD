...
#     # 或 adapter_path = r"output\v20-20241230-225736\checkpoint-10"
...
def infer_pt(prompt):
    ...
    #adapter_path = safe_snapshot_download(r"output\v20-20241230-225736\checkpoint-10")
    adapter_path = r"output\v20-20241230-225736\checkpoint-10-merged"
    args = BaseArguments.from_pretrained(adapter_path)
...
if __name__ == '__main__':
    ...
    prompt = "为什么女生冬天晚上手脚冰凉？"
    #infer_request = InferRequest(messages=[{'role': 'user', 'content': prompt}])
    
    #infer_multilora(infer_request, 'pt')
    #infer_multilora(infer_request, 'vllm')  # windows中可能会报错
